...
**[http://157.173.101.159:8261](http://157.173.101.159:8261)** *(Update IP if deploying elsewhere)*
...
This project strictly adheres to isolated topics under `rfid/Nshuti_Christian/`:

| Action | Topic | Payload Example |
| --- | --- | --- |
| **Card Status** | `rfid/Nshuti_Christian/card/status` | `{"uid": "A1B2C3D4", "balance": 3000}` |
| **Top-Up Command** | `rfid/Nshuti_Christian/card/topup` | `{"uid": "A1B2C3D4", "amount": 500}` |
| **Top-Up Result** | `rfid/Nshuti_Christian/card/topup/result` | `{"success": true, "uid": "...", "amount": 500, "new_balance": 3500, "message": "Success"}` |
| **Payment Command**| `rfid/Nshuti_Christian/card/payment` | `{"uid": "A1B2C3D4", "amount": 500}` |
| **Payment Result** | `rfid/Nshuti_Christian/card/payment/result` | `{"success": true, "uid": "...", "amount": 500, "new_balance": 3000, "message": "Success"}` |
